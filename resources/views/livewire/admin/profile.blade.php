    ...
    <div class="min-h-screen bg-gray-50 mx-auto my-auto rounded-xl shadow">
        ...
        <div class="p-6">
            ...
            <div class="flex items-center gap-6 pb-6 border-b mb-6">
                ...
                {{-- Foto --}}
                <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-blue-200 bg-gray-200">
                    @if($foto)
                ...
                <div>
                    ...
                    <span class="mt-2 inline-block px-3 py-1 rounded-full bg-blue-100 text-blue-700 text-sm font-medium">
